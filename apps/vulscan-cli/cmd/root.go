// Package cmd implements the Cobra CLI commands for 911VulScan.
package cmd
...
var rootCmd = &cobra.Command{
	...
	Long: `911VulScan is a two-stage SAST tool that uses Claude to find real vulnerabilities
...
func requireAPIKey() string {
	...
	fmt.Fprintln(os.Stderr, "Run:  vulscan set-api-key")
	fmt.Fprintln(os.Stderr, "  or: echo \"$ANTHROPIC_API_KEY\" | vulscan set-api-key --stdin")
	fmt.Fprintln(os.Stderr, "")
