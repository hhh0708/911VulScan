...
class TestTokenTracker:
    ...
    def test_record_call_known_model(self):
        tracker = TokenTracker()
        result = tracker.record_call("claude-opus-4-6", 1000, 500)
    ...
    def test_cumulative_tracking(self):
        tracker = TokenTracker()
        tracker.record_call("claude-opus-4-6", 1000, 500)
        tracker.record_call("claude-opus-4-6", 2000, 1000)
    ...
    def test_get_summary_includes_calls(self):
        tracker = TokenTracker()
        tracker.record_call("claude-opus-4-6", 100, 50)
