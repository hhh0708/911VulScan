...
911VulScan uses Claude to analyze code for security vulnerabilities through a two-stage pipeline: detection followed by verification. Features 4-level cost optimization with CodeQL integration. Supports Python, JavaScript/TypeScript, and Go.
...
git clone https://github.com/your-org/vulscan.git
cd vulscan
...
911VulScan generates application context to understand what type of application is being analyzed. This dramatically reduces false positives by understanding what behaviors are intentional vs vulnerable.
...
Create `911VULSCAN.md` or `911VULSCAN.json` in your repository root to provide manual security context. This is useful when:
...
See `context/911VULSCAN_TEMPLATE.md` for the complete format and examples.
...
│   └── 911VULSCAN_TEMPLATE.md   # Manual override template
...
| `911VULSCAN.md` | Architecture documentation |
| `911VULSCAN_TWO_STAGE_PLANNING.md` | Pipeline design rationale |
| `context/911VULSCAN_TEMPLATE.md` | Manual override format & examples |
