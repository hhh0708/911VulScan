...
// Repository paths for each dataset (adjust to your local checkouts)
const os = require('os');
const REPOS = {
    'dvna': path.join(os.homedir(), 'code', 'dvna'),
    'nodegoat': path.join(os.homedir(), 'code', 'NodeGoat'),
    'juice_shop': path.join(os.homedir(), 'code', 'juice-shop')
};
