...
**Output:** Dataset compatible with 911VulScan
...
Generate both dataset and analyzer output for full 911VulScan integration:
...
The final dataset is compatible with 911VulScan's `experiment.py`:
