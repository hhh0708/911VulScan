...
This is the Python code parser for 911VulScan (a SAST tool). It mirrors the JavaScript parser in `~/code/vulscan/parsers/javascript/`.
...
**Output format matches 911VulScan's experiment.py expectations:**
```python
{
    "id": "file.py:func",
    "unit_type": "function",
