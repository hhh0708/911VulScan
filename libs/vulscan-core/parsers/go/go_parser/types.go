...
// This format is compatible with 911VulScan's Stage 2 verification tools
...
// UnresolvedEdge records a call that could not be uniquely resolved.
...
// Dataset represents the final 911VulScan-compatible output (Stage 4)
type Dataset struct {
	Name       string          `json:"name"`
	Repository string          `json:"repository"`
