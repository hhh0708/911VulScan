...
class RepositoryScanner:
    ...
    def scan(self) -> Dict[str, Any]:
        ...
        for root, dirs, filenames in os.walk(self.repo_path):
            ...
            # Never descend into symlinked directories (untrusted repo).
            real_dirs = []
            for d in dirs:
            ...
            directories_excluded += len(real_dirs) - len(dirs)
            ...
            for filename in filenames:
                ...
                if file_path.is_symlink():
                    # Skip symlinks: external targets would leak files
                    # outside the repo into LLM prompts.
                    symlinks_skipped += 1
                    continue
