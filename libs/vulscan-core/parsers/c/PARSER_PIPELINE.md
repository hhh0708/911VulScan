...
A tree-sitter-based parser for extracting functions, building call graphs, and generating 911VulScan dataset format from C/C++ codebases.
...
| `dataset.json` | 911VulScan dataset format (input to experiment.py) |
