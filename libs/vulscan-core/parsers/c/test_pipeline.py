...
4. UnitGenerator     - Creates 911VulScan dataset format
...
class CPipelineTest:
    def __init__(
        ...
        self.supplemental_paths = supplemental_paths or []
    ...
    def run_parser_pipeline(self) -> bool:
        ...
        try:
            ...
            scanner_options = {
                ...
                'supplemental_paths': self.supplemental_paths,
            }
            ...
            try:
                ...
                write_call_graph(call_graph_file, graph_result, language='c')
            except Exception:
    ...
    def apply_reachability_filter(self) -> bool:
        ...
        try:
            ...
            print(
                f"  Units: {summary['original_units']} -> "
...
"""
    ...
    parser.add_argument(
        ...
        default=None,
        help='JSON file with {"paths": ["abs/path/to/generated.c", ...]}',
    )
    ...
    supplemental_paths = []
    if args.supplemental_manifest and os.path.exists(args.supplemental_manifest):
        try:
            manifest = read_json(args.supplemental_manifest)
            supplemental_paths = manifest.get('paths', manifest.get('supplemental_paths', []))
