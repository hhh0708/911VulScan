...
CONSISTENCY_MODEL = model_for(ModelRole.SECONDARY)
MAX_TOKENS = 4096
...
def _resolve_stage1_inconsistency(
    ...
    try:
        from utilities.llm_json_utils import DEFAULT_JSON_RETRIES, combine_system_prompt
        ...
        result = client.analyze_json_sync(
            ...
            system=combine_system_prompt(
                "You are checking verdict consistency across similar code patterns "
                "in a security analysis."
            ),
            context="stage1 consistency",
