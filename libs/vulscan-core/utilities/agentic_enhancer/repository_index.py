...
class RepositoryIndex:
    ...
    def read_file_section(self, file_path: str, start_line: int, end_line: int) -> Optional[str]:
        ...
        # file_path comes from LLM tool calls; resolve and confine it to the
        # repository root so crafted "../" / absolute paths cannot read host
        # files (e.g. /etc/passwd, ~/.config/vulscan/config.json).
        try:
