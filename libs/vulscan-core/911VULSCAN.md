# 911VulScan Architecture Documentation

911VulScan is an LLM-powered Static Application Security Testing (SAST) tool that uses a two-stage pipeline for vulnerability analysis with 4-level cost optimization. Supports Python, JavaScript/TypeScript, and Go.
...
Traditional SAST tools rely on pattern matching, producing high false positive rates. 911VulScan uses Claude for semantic code analysis with a two-stage approach:
...
- `911VULSCAN_TWO_STAGE_PLANNING.md` - Two-stage pipeline details
