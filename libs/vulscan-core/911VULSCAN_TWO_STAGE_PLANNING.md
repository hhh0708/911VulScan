# 911VulScan Two-Stage Vulnerability Analysis
...
911VulScan uses a two-stage approach for vulnerability analysis. Stage 1 detects potential issues with simple, direct prompts. Stage 2 verifies each finding using Opus with tool access to explore the codebase.
